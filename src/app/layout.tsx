...
export const metadata: Metadata = {
  title: "Alessandro Noya - Student, Pilot, Athlete & Chess Player",
  description: "High school junior at Torrey Pines excelling in academics while pursuing pilot license, volleyball, and chess mastery. Born in Rio, raised in Rome, thriving in San Diego.",
  keywords: "Alessandro Noya, Torrey Pines High School, student pilot, volleyball player, chess prodigy, Rio de Janeiro, Rome, San Diego, high school achievements",
  metadataBase: new URL("https://example.com"),
  alternates: {
    canonical: "https://example.com"
  },
  openGraph: {
    title: "Alessandro Noya - Multi-talented High School Achiever",
    description: "From Rio to Rome to San Diego - follow Alessandro's journey in academics, aviation, volleyball, and chess excellence.",
    siteName: "Alessandro Noya Portfolio",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763226234822-kgtoifag.jpg",
      alt: "Alessandro Noya - student, pilot, athlete, chess player"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Alessandro Noya - Student, Pilot, Athlete & Chess Player",
    description: "High school junior excelling in academics, aviation training, volleyball, and chess at Torrey Pines High School.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763226234822-kgtoifag.jpg"]
  },
  robots: {
    index: true,
    follow: true
